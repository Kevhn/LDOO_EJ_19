...
public class RegistrarUsuarios extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        factoria.agregarUsuario(request.getParameter("user"), request.getParameter("password"), request.getParameter("birthdate"), request.getParameter("email"), request.getParameter("usertype"), Integer.parseInt(request.getParameter("userid")), Integer.parseInt(request.getParameter("employeenumber")), request.getParameter("name"), request.getParameter("suscriptiontype"), request.getParameter("address"), request.getParameter("registerdate"));
